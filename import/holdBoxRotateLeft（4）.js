Blockly.Blocks['1781338425671'] = {
  init: function() {
    this.jsonInit({
      "type": "1781338425671",
      "message0": "holdBoxRotateLeft（4）",
...
Blockly.Lua['1781338425671'] = function(block) {
...
Blockly.Python['1781338425671'] = function(block) {
  let code = "base_action.action('holdBoxRotateLeft（4）')\n";
  return code;
}
