Blockly.Blocks['1781316122690'] = {
  init: function() {
    this.jsonInit({
      "type": "1781316122690",
      "message0": "holdBoxMoveBack（2）",
...
Blockly.Lua['1781316122690'] = function(block) {
...
Blockly.Python['1781316122690'] = function(block) {
  let code = "base_action.action('holdBoxMoveBack（2）')\n";
  return code;
}
